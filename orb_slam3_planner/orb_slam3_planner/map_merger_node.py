...
class MapMergerNode(Node):
            ...
            if response:
                ...
                if len(valid_points) != len(points):
                    self.get_logger().warn(
                        f"Skipped {len(points) - len(valid_points)} invalid map points from robot_{robot_id}.")
    ...
    def transform_landmarks_to_global(self, map_points, robot_id):
        ...
        for point in map_points:
            ...
            transformed_points_with_id.append(
                [transformed_point_xyz[0], transformed_point_xyz[1], transformed_point_xyz[2], robot_id])
