...
class ImprovedMapMergerNode(Node):
    def __init__(self):
        ...
        self.robots = {
            0: {'position': [-5.0, -7.0, 0.5], 'orientation': [0.0, 0.0, 0.0]},  # Blue
            1: {'position': [-1.0, 0.0, 0.5], 'orientation': [0.0, 0.0, 0.0]},  # Green
            # 2: {'position': [5.0, 5.0, 0.5], 'orientation': [0.0, 0.0, 0.0]}  # Red
        }
